## Project Title: AD 311  Converting HTML Profile Card to JSX
#### By: Amde Wubshet
...
### Commands 
After installing the repo, navigate into your project directory: *cd html-to-jsx-profilecard*. Then start the development server: *npm start*. 
